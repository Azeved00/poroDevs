...
public class PoroCoins implements ModInitializer {
	...
	/*public static final EntityType<RedFungusEntity> RED_FUNGUS_ENTITY = 
		FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, RedFungusEntity::new)
			.dimensions(EntityDimensions.fixed(1.05F, 1.4F))
			.build();*/
