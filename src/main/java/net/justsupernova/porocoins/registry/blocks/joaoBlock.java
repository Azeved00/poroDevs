...
public class joaoBlock {

    public static final Block JOAO_BLOCK = new Block(FabricBlockSettings
            .of(Material.METAL)
    ...
    public static final Block JOAO_ORE = new Block(FabricBlockSettings
            .of(Material.STONE)
            .breakByTool(FabricToolTags.PICKAXES, 2)
            .requiresTool()
            .strength(3.0f,30.0f)
    ...
    private static ConfiguredFeature<?, ?> ORE_JOAO_OVERWORLD = Feature.ORE
            .configure(new OreFeatureConfig(
                    OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
                    JOAO_ORE.getDefaultState(),
                    9)) // Vein size
    ...
    public static void registerFeature() {
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, orejoaoOverworld.getValue(), ORE_JOAO_OVERWORLD);
    ...
    public static void register(){
        Registry.register(Registry.BLOCK, new Identifier(PoroCoins.MOD_ID, "joao_block"), JOAO_BLOCK);
